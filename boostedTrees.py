...
# Import the GradientBoostingClassifier from scikit-learn for boosted trees
...
def train_boosted_trees_classifier(df):
    """
    Train a Gradient Boosting classifier (boosted trees) using student data.
    ...
    Returns:
        model (GradientBoostingClassifier): The trained Gradient Boosting classifier.
    """
...
def predict_dropout(model, new_data):
    """
    Predict the dropout status for new student data using the trained Gradient Boosting classifier.

    Parameters:
        model (GradientBoostingClassifier): The trained classifier.
    ...
    # Use the trained model to predict dropout status.
...
if __name__ == "__main__":
    ...
    # -------------------------------------------------------------------------
    # Step 2: Train the Gradient Boosting classifier using the fetched data.
    # -------------------------------------------------------------------------
    print("\nTraining Gradient Boosting classifier (Boosted Trees)...")
    boosted_trees_model = train_boosted_trees_classifier(df)
    ...
    dropout_predictions = predict_dropout(boosted_trees_model, new_students)
