...
def train_random_forest_classifier(df, n_estimators=100, random_state=42):
    """
    Train a Random Forest classifier using student data.
    ...
    # For this small dataset, we'll train on the entire dataset.
...
def predict_dropout(model, new_data):
    """
    Predict the dropout status for new student data using the trained Random Forest classifier.
    ...
    # Use the Random Forest model to predict dropout status for the new data.
...
if __name__ == "__main__":
    ...
    # -------------------------------------------------------------------------
    # Step 2: Train the Random Forest classifier using the fetched data.
    # -------------------------------------------------------------------------
    print("\nTraining Random Forest classifier...")
    rf_model = train_random_forest_classifier(df)
    ...
    dropout_predictions = predict_dropout(rf_model, new_students)
