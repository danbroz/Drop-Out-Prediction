...
def train_neural_network_classifier(df):
    """
    Train a Neural Network classifier (MLPClassifier) for binary classification using student data.
    ...
    # Here, we use a single hidden layer with 10 neurons.
    model = make_pipeline(
        StandardScaler(),
...
if __name__ == "__main__":
    ...
    # -------------------------------------------------------------------------
    print("\nTraining Neural Network classifier for binary classification...")
